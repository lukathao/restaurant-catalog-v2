    ...
    <div className="bg-gray-100 min-h-screen">
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto bg-white rounded-lg shadow-lg p-8">
            ...
            <p className="mb-6">
              Foodicats is committed to protecting your privacy and
            ...
            <p className="mb-6">
              ...
              contact with the Contact Us button at the bottom of this page.
            </p>
      ...
      <section className="py-16 bg-gray-200">
        <div className="container mx-auto px-4 text-center">
          ...
          <Link
            href="/contact"
            className="bg-foodOrange text-white px-6 py-3 rounded-lg hover:bg-blue-700 transition duration-300 inline-block"
          >
            Contact Us
          </Link>
        </div>
